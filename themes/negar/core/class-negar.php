        ...
        public function ngr_pwa_moda_render(  ) {
            ...
            if ( is_front_page() && $avn_negar['pwa_activation'] == 1 ) {
                ...
                <div class="add-shortcut-btn" data-cookie="<?=$set_cookie?>">
                    ...
                    <?php } ?>
                    <div class="andriod">
                        <p class="pwa-title">برای دسترسی سریع تر به فروشگاه میتوانید از وب اپلیکیشن سایت استفاده کنید.برای افزوده شدن وب اپلیکیشن کافیست دکمه زیر را لمس کنید.</p>
                        <button class="add-mobile-view">نصب وب اپلیکیشن</button>
                        <button class="cancel-mobile-view">متوجه شدم! فعلا نه !</button>
                    </div>
                    <div class="ios">
                        <p class="pwa-title">برای دسترسی سریع تر به فروشگاه میتوانید از وب اپلیکیشن سایت استفاده کنید.کافیست مطابق آموزش زیر عمل کنید :</p>
