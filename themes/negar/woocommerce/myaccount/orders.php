	...
	foreach ( $customer_orders->orders as $customer_order ) {
        ...
        <a href="<?php echo esc_url( $order->get_view_order_url() ); ?>">
            <table class="woocommerce-orders-table woocommerce-MyAccount-orders">
                <tbody>
                <tr>
                    <td> شماره سفارش : <?php echo '<span>'. esc_html( _x( '#', 'hash before order number', 'woocommerce' ) . $order->get_order_number() ) . '</span>'; ?></td>
                    <td>

                    </td>
                    <td class="order-status <?php echo esc_attr( $order->get_status() ); ?>">
                ...
                <tr>
                    <td class="order-count">
						...
						echo '<span>' . wp_kses_post( $item_count ) . '</span> محصول در این سفارش ';
						?>
                    </td>
                    <td>
