        ...
        class ReduxFramework_import_export extends ReduxFramework {
            ...
            public function render() {
                ...
                ?>
                    ...
                    <p id="redux-import-action"><input type="submit" id="redux-import" name="import" class="button-primary" value="<?php esc_html_e( 'Import', 'redux-framework' ) ?>">&nbsp;&nbsp;<span><?php echo 'هشدار ! با درون آوری موارد تمامی اطلاعات تغییر خواهد کرد'; ?></span></p>

                    <div class="hr"/>
                    <div class="inner"><span>&nbsp;</span></div></div>
                    <h4><?php echo 'تنظیمات برون ریزی' ?></h4>

                    <div class="redux-section-desc">
                        <p class="description">
                            <?php echo 'در این قسمت می توانید تنظیمات گزینه های فعلی خود را کپی / بارگیری کنید و از تنظیمات فعلی خود نسخه ای پشتیبان داشته باشید.'; ?>
                        </p>
                    </div>
                <?php
                ...
                ?>
                    <p>
                        <a href="javascript:void(0);" id="redux-export-code-copy" class="button-secondary"><?php echo 'کپی داده ها' ?></a>
                        <a href="<?php echo $link; ?>" id="redux-export-code-dl" class="button-primary"><?php echo 'دانلود فایل داده ها' ?></a>
                        <a href="javascript:void(0);" id="redux-export-link" class="button-secondary"><?php echo 'کپی آدرس خروجی' ?></a>
                    </p>
